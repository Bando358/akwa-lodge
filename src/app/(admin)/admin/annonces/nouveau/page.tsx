...
import { ArrowLeft, Loader2, Save, Megaphone, ImageIcon, Video, FileText } from "lucide-react";
                  ...
                  {(watchMediaType === "IMAGE" || watchMediaType === "VIDEO") && (
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>
                            {watchMediaType === "IMAGE" ? "Image" : "Vidéo"} *
                          </FormLabel>
                          <FormControl>
                            <ImageUpload
                              value={field.value || ""}
                              onChange={(url) => field.onChange(url)}
                              acceptVideo={watchMediaType === "VIDEO"}
                            />
                          </FormControl>
                          <FormDescription>
                            {watchMediaType === "VIDEO"
                              ? "Uploadez une vidéo courte (3-5 secondes max)"
                              : "Uploadez une image pour votre annonce"}
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
